...
namespace ReactorServer.Utils.Pem
{
    public class PemKeyUtils
    {
        ...
        public static RSACryptoServiceProvider GetRSAProviderFromPemFile(string pem)
        {
        ...
        public static string ExportPublicKey(RSACryptoServiceProvider csp)
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                b.AppendLine("-----BEGIN PUBLIC KEY-----");
                for (var i = 0; i < base64.Length; i += 64)
                {
                    char[] line = new char[Math.Min(64, base64.Length - i)];
                    Array.Copy(base64,i,line,0, Math.Min(64, base64.Length - i));
                    b.AppendLine(new string(line));
                }
                b.AppendLine("-----END PUBLIC KEY-----");
